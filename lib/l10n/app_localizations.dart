...
abstract class AppLocalizations {
  ...
  /// No description provided for @equip_name.
  ///
  /// In zh, this message translates to:
  /// **'装备名'**
  String get equip_name;

  /// No description provided for @favorite_equip.
  ///
  /// In zh, this message translates to:
  /// **'收藏装备'**
  String get favorite_equip;

  /// No description provided for @favorite_equip_material.
  ///
  /// In zh, this message translates to:
  /// **'收藏素材'**
  String get favorite_equip_material;

  /// No description provided for @tool_equip.
  ///
  /// In zh, this message translates to:
  /// **'装备'**
  String get tool_equip;

  /// No description provided for @equip_material.
  ///
  /// In zh, this message translates to:
  /// **'合成素材'**
  String get equip_material;

  /// No description provided for @equip_max_select_count.
  ///
  /// In zh, this message translates to:
  /// **'最多可选 {arg1} 个装备'**
  String equip_max_select_count(int arg1);

  /// No description provided for @equip_search.
  ///
  /// In zh, this message translates to:
  /// **'开始查询'**
  String get equip_search;

  /// No description provided for @equip_search_mode.
  ///
  /// In zh, this message translates to:
  /// **'掉落查询'**
  String get equip_search_mode;

  /// No description provided for @tip_equip_search.
  ///
  /// In zh, this message translates to:
  /// **'请先选择装备'**
  String get tip_equip_search;

  /// No description provided for @picked_equip.
  ///
  /// In zh, this message translates to:
  /// **'已选择'**
  String get picked_equip;

  /// No description provided for @tool_leader.
  ///
  /// In zh, this message translates to:
  /// **'角色排行'**
  String get tool_leader;

  /// No description provided for @leader_score.
  ///
  /// In zh, this message translates to:
  /// **'角色评分'**
  String get leader_score;
  ...
  /// No description provided for @tool_calendar_inprogress.
  ///
  /// In zh, this message translates to:
  /// **'进行中活动'**
  String get tool_calendar_inprogress;

  /// No description provided for @tool_calendar_coming.
  ///
  /// In zh, this message translates to:
  /// **'活动预告'**
  String get tool_calendar_coming;

  /// No description provided for @tool_calendar_event.
  ///
  /// In zh, this message translates to:
  /// **'活动记录'**
  String get tool_calendar_event;

  /// No description provided for @tool_website.
  ///
  /// In zh, this message translates to:
  /// **'收藏夹'**
  String get tool_website;

  /// No description provided for @tool_clan.
  ///
  /// In zh, this message translates to:
  /// **'公会战'**
  String get tool_clan;

  /// No description provided for @tool_clan_no_boss.
  ///
  /// In zh, this message translates to:
  /// **'BOSS 信息暂未实装'**
  String get tool_clan_no_boss;

  /// No description provided for @tool_guild.
  ///
  /// In zh, this message translates to:
  /// **'角色公会'**
  String get tool_guild;
  ...
  /// No description provided for @tool_gacha.
  ///
  /// In zh, this message translates to:
  /// **'卡池'**
  String get tool_gacha;

  /// No description provided for @tool_free_gacha.
  ///
  /// In zh, this message translates to:
  /// **'免费十连'**
  String get tool_free_gacha;

  /// No description provided for @tool_birthday.
  ///
  /// In zh, this message translates to:
  /// **'生日'**
  String get tool_birthday;

  /// No description provided for @tool_event.
  ///
  /// In zh, this message translates to:
  /// **'剧情活动'**
  String get tool_event;

  /// No description provided for @tool_news.
  ///
  /// In zh, this message translates to:
  /// **'公告'**
  String get tool_news;
  ...
  /// No description provided for @jjc.
  ///
  /// In zh, this message translates to:
  /// **'竞技场'**
  String get jjc;
  ...
  /// No description provided for @sp_dungeon.
  ///
  /// In zh, this message translates to:
  /// **'特殊地下城'**
  String get sp_dungeon;

  /// No description provided for @tdf.
  ///
  /// In zh, this message translates to:
  /// **'次元断层'**
  String get tdf;
  ...
  /// No description provided for @abyss.
  ///
  /// In zh, this message translates to:
  /// **'深渊讨伐战'**
  String get abyss;
  ...
  /// No description provided for @character_name.
  ///
  /// In zh, this message translates to:
  /// **'角色名'**
  String get character_name;
  ...
  /// No description provided for @comic_4.
  ///
  /// In zh, this message translates to:
  /// **'4格漫画'**
  String get comic_4;

  /// No description provided for @comic_toc.
  ///
  /// In zh, this message translates to:
  /// **'目录'**
  String get comic_toc;

  /// No description provided for @comic_toc_index.
  ///
  /// In zh, this message translates to:
  /// **'第{arg1}话'**
  String comic_toc_index(int arg1);

  /// No description provided for @comic_input_hint.
  ///
  /// In zh, this message translates to:
  /// **'输入跳转，如：382'**
  String get comic_input_hint;
  ...
  /// No description provided for @tip_no_equip_get_area.
  ///
  /// In zh, this message translates to:
  /// **'暂无掉落区域'**
  String get tip_no_equip_get_area;

  /// No description provided for @title_recently_used.
  ///
  /// In zh, this message translates to:
  /// **'常用'**
  String get title_recently_used;
