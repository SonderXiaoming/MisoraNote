...
class TalentQuestEnemyParameter extends Table {
  @override
  String get tableName => "talent_quest_enemy_parameter";
  @override
  Set<Column> get primaryKey => {enemyId};
  IntColumn get enemyId => integer().named("enemy_id")();
  IntColumn get unitId => integer().named("unit_id")();
...
class EventEnemyParameter extends Table {
  @override
  String get tableName => "event_enemy_parameter";
  @override
  Set<Column> get primaryKey => {enemyId};
  IntColumn get enemyId => integer().named("enemy_id")();
  IntColumn get unitId => integer().named("unit_id")();
...
class ShioriEnemyParameter extends Table {
  @override
  String get tableName => "shiori_enemy_parameter";
  @override
  Set<Column> get primaryKey => {enemyId};
  IntColumn get enemyId => integer().named("enemy_id")();
  IntColumn get unitId => integer().named("unit_id")();
...
class SreEnemyParameter extends Table {
  @override
  String get tableName => "sre_enemy_parameter";
  @override
  Set<Column> get primaryKey => {enemyId};
  IntColumn get enemyId => integer().named("enemy_id")();
  IntColumn get unitId => integer().named("unit_id")();
...
class TowerEnemyParameter extends Table {
  @override
  String get tableName => "tower_enemy_parameter";
  @override
  Set<Column> get primaryKey => {enemyId};
  IntColumn get enemyId => integer().named("enemy_id")();
  IntColumn get unitId => integer().named("unit_id")();
  ...
  IntColumn get resistVariationId => integer().named("resist_variation_id")();
  IntColumn get accuracy => integer().named("accuracy")();
  IntColumn get enemyColor => integer().named("enemy_color")();
}

class SevenEnemyParameter extends Table {
  @override
  String get tableName => "seven_enemy_parameter";
  @override
  Set<Column> get primaryKey => {enemyId};
  IntColumn get enemyId => integer().named("enemy_id")();
  IntColumn get unitId => integer().named("unit_id")();
...
class EnemyTalentWeakness extends Table {
  ...
  IntColumn get enemyId => integer().named("enemy_id")();
  IntColumn get resistId => integer().named("resist_id")();
}
...
class TalentWeakness extends Table {
  ...
  IntColumn get resistId => integer().named("resist_id")();
  IntColumn get talent1 => integer().named("talent_1")();
  IntColumn get talent2 => integer().named("talent_2")();
