...
class $RedeemUnitTable extends RedeemUnit
  ...
  RedeemUnitData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return RedeemUnitData(
      ...
      consumeNum: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  RedeemUnitData copyWithCompanion(RedeemUnitCompanion data) {
    return RedeemUnitData(
      ...
      conditionId: data.conditionId.present
          ...
          : this.conditionId,
      consumeNum: data.consumeNum.present
          ? data.consumeNum.value
          : this.consumeNum,
    );
  }
...
class UnitDataData extends DataClass implements Insertable<UnitDataData> {
  ...
  UnitDataCompanion toCompanion(bool nullToAbsent) {
    return UnitDataCompanion(
      ...
      motionType: motionType == null && nullToAbsent
          ? const Value.absent()
          : Value(motionType),
      seType: seType == null && nullToAbsent
          ? const Value.absent()
          : Value(seType),
      ...
      cutin1: cutin1 == null && nullToAbsent
          ? const Value.absent()
          : Value(cutin1),
      cutin2: cutin2 == null && nullToAbsent
          ? const Value.absent()
          : Value(cutin2),
  ...
  UnitDataData copyWith({
    ...
    prefabIdBattle: prefabIdBattle.present
        ? prefabIdBattle.value
        : this.prefabIdBattle,
    ...
    guildId: guildId.present ? guildId.value : this.guildId,
    exskillDisplay: exskillDisplay.present
        ? exskillDisplay.value
        : this.exskillDisplay,
    comment: comment.present ? comment.value : this.comment,
    onlyDispOwned: onlyDispOwned.present
        ? onlyDispOwned.value
        : this.onlyDispOwned,
    startTime: startTime.present ? startTime.value : this.startTime,
    endTime: endTime.present ? endTime.value : this.endTime,
    originalUnitId: originalUnitId.present
  ...
  UnitDataData copyWithCompanion(UnitDataCompanion data) {
    return UnitDataData(
      ...
      cutin1Star6: data.cutin1Star6.present
          ? data.cutin1Star6.value
          : this.cutin1Star6,
      cutin2Star6: data.cutin2Star6.present
          ? data.cutin2Star6.value
          : this.cutin2Star6,
      guildId: data.guildId.present ? data.guildId.value : this.guildId,
  ...
  UniqueEquipmentEnhanceDataData copyWithCompanion(
    ...
    return UniqueEquipmentEnhanceDataData(
      ...
      enhanceLevel: data.enhanceLevel.present
          ...
          : this.enhanceLevel,
      neededPoint: data.neededPoint.present
          ? data.neededPoint.value
          : this.neededPoint,
      totalPoint: data.totalPoint.present
          ? data.totalPoint.value
          : this.totalPoint,
      neededMana: data.neededMana.present
          ? data.neededMana.value
          : this.neededMana,
...
class $Rarity6QuestDataTable extends Rarity6QuestData
  ...
  Rarity6QuestDataData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Rarity6QuestDataData(
      rarity6QuestId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
      ...
      limitTime: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
      ...
      treasureType: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}treasure_type'],
      )!,
      rewardImage1: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}reward_image_1'],
      )!,
      rewardCount1: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}reward_count_1'],
      )!,
      rewardImage2: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}reward_image_2'],
      )!,
      rewardCount2: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}reward_count_2'],
      )!,
      rewardImage3: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}reward_image_3'],
      )!,
      rewardCount3: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}reward_count_3'],
      )!,
      rewardImage4: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}reward_image_4'],
      )!,
      rewardCount4: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}reward_count_4'],
      )!,
      rewardImage5: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}reward_image_5'],
      )!,
      rewardCount5: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
      ...
      bgPosition: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
      ...
      enemyLocalPositionY1: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}enemy_local_position_y_1'],
      )!,
      enemySize1: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
      ...
      enemyLocalPositionY2: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}enemy_local_position_y_2'],
      )!,
      enemySize2: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
      ...
      enemyLocalPositionY3: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}enemy_local_position_y_3'],
      )!,
      enemySize3: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
      ...
      enemyLocalPositionY4: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}enemy_local_position_y_4'],
      )!,
      enemySize4: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
      ...
      enemyLocalPositionY5: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}enemy_local_position_y_5'],
      )!,
      enemySize5: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}enemy_size_5'],
      )!,
      waveBgm: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
  ...
  Rarity6QuestDataData copyWithCompanion(Rarity6QuestDataCompanion data) {
    return Rarity6QuestDataData(
      ...
      background: data.background.present
          ...
          : this.background,
      bgPosition: data.bgPosition.present
          ? data.bgPosition.value
          : this.bgPosition,
      ...
      enemySize1: data.enemySize1.present
          ? data.enemySize1.value
          : this.enemySize1,
      ...
      enemySize2: data.enemySize2.present
          ? data.enemySize2.value
          : this.enemySize2,
      ...
      enemySize3: data.enemySize3.present
          ? data.enemySize3.value
          : this.enemySize3,
      ...
      enemySize4: data.enemySize4.present
          ? data.enemySize4.value
          : this.enemySize4,
      ...
      enemySize5: data.enemySize5.present
          ? data.enemySize5.value
          : this.enemySize5,
...
class $SkillDataTable extends SkillData
  ...
  SkillDataData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SkillDataData(
      ...
      skillType: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}skill_type'],
      )!,
      skillAreaWidth: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
      ...
      action1: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}action_1'],
      )!,
      action2: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}action_2'],
      )!,
      action3: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}action_3'],
      )!,
      action4: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}action_4'],
      )!,
      action5: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}action_5'],
      )!,
      action6: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}action_6'],
      )!,
      action7: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}action_7'],
      )!,
      action8: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}action_8'],
      )!,
      action9: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}action_9'],
      )!,
      action10: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
      ...
      actionDepend2: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}depend_action_2'],
      )!,
      actionDepend3: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}depend_action_3'],
      )!,
      actionDepend4: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}depend_action_4'],
      )!,
      actionDepend5: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}depend_action_5'],
      )!,
      actionDepend6: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}depend_action_6'],
      )!,
      actionDepend7: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}depend_action_7'],
      )!,
      actionDepend8: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}depend_action_8'],
      )!,
      actionDepend9: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}depend_action_9'],
      )!,
      actionDepend10: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
...
class SkillDataData extends DataClass implements Insertable<SkillDataData> {
  ...
  SkillDataData copyWith({
    ...
    bossUbCoolTime: bossUbCoolTime.present
        ? bossUbCoolTime.value
        : this.bossUbCoolTime,
...
class $UnitSkillDataTable extends UnitSkillData
  ...
  UnitSkillDataData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return UnitSkillDataData(
      ...
      unionBurst: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}union_burst'],
      )!,
      spUnionBurst: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
      ...
      mainSkill1: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}main_skill_1'],
      )!,
      mainSkill2: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}main_skill_2'],
      )!,
      mainSkill3: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}main_skill_3'],
      )!,
      mainSkill4: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}main_skill_4'],
      )!,
      mainSkill5: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}main_skill_5'],
      )!,
      mainSkill6: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}main_skill_6'],
      )!,
      mainSkill7: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}main_skill_7'],
      )!,
      mainSkill8: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}main_skill_8'],
      )!,
      mainSkill9: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}main_skill_9'],
      )!,
      mainSkill10: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
      ...
      exSkill2: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}ex_skill_2'],
      )!,
      exSkill3: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}ex_skill_3'],
      )!,
      exSkill4: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}ex_skill_4'],
      )!,
      exSkill5: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
      ...
      spSkill1: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}sp_skill_1'],
      )!,
      spSkill2: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}sp_skill_2'],
      )!,
      spSkill3: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}sp_skill_3'],
      )!,
      spSkill4: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}sp_skill_4'],
      )!,
      spSkill5: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
...
class UnitSkillDataData extends DataClass
  ...
  UnitSkillDataData copyWithCompanion(UnitSkillDataCompanion data) {
    return UnitSkillDataData(
      unitId: data.unitId.present ? data.unitId.value : this.unitId,
      unionBurst: data.unionBurst.present
          ? data.unionBurst.value
          : this.unionBurst,
      ...
      unionBurstEvolution: data.unionBurstEvolution.present
          ...
          : this.unionBurstEvolution,
      mainSkill1: data.mainSkill1.present
          ? data.mainSkill1.value
          : this.mainSkill1,
      mainSkill2: data.mainSkill2.present
          ? data.mainSkill2.value
          : this.mainSkill2,
      mainSkill3: data.mainSkill3.present
          ? data.mainSkill3.value
          : this.mainSkill3,
      mainSkill4: data.mainSkill4.present
          ? data.mainSkill4.value
          : this.mainSkill4,
      mainSkill5: data.mainSkill5.present
          ? data.mainSkill5.value
          : this.mainSkill5,
      mainSkill6: data.mainSkill6.present
          ? data.mainSkill6.value
          : this.mainSkill6,
      mainSkill7: data.mainSkill7.present
          ? data.mainSkill7.value
          : this.mainSkill7,
      mainSkill8: data.mainSkill8.present
          ? data.mainSkill8.value
          : this.mainSkill8,
      mainSkill9: data.mainSkill9.present
          ? data.mainSkill9.value
          : this.mainSkill9,
      mainSkill10: data.mainSkill10.present
          ? data.mainSkill10.value
          : this.mainSkill10,
...
class $SkillActionTable extends SkillAction
  ...
  SkillActionData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return SkillActionData(
      ...
      actionDetail1: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}action_detail_1'],
      )!,
      actionDetail2: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}action_detail_2'],
      )!,
      actionDetail3: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}action_detail_3'],
      )!,
      actionValue1: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}action_value_1'],
      )!,
      actionValue2: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}action_value_2'],
      )!,
      actionValue3: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}action_value_3'],
      )!,
      actionValue4: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}action_value_4'],
      )!,
      actionValue5: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}action_value_5'],
      )!,
      actionValue6: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}action_value_6'],
      )!,
      actionValue7: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}action_value_7'],
      )!,
      targetAssignment: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}target_assignment'],
      )!,
      targetArea: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}target_area'],
      )!,
      targetRange: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
...
class SkillActionData extends DataClass implements Insertable<SkillActionData> {
  ...
  SkillActionData copyWithCompanion(SkillActionCompanion data) {
    return SkillActionData(
      ...
      targetArea: data.targetArea.present
          ? data.targetArea.value
          : this.targetArea,
      targetRange: data.targetRange.present
      ...
      description: data.description.present
          ? data.description.value
          : this.description,
      levelUpDisp: data.levelUpDisp.present
          ? data.levelUpDisp.value
          : this.levelUpDisp,
    );
  }
...
class $AilmentDataTable extends AilmentData
  ...
  AilmentDataData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return AilmentDataData(
      ailmentId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}ailment_id'],
      )!,
      ailmentAction: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}ailment_action'],
      )!,
      ailmentDetail1: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
  ...
  AilmentDataData copyWithCompanion(AilmentDataCompanion data) {
    return AilmentDataData(
      ...
      ailmentDetail1: data.ailmentDetail1.present
          ...
          : this.ailmentDetail1,
      ailmentName: data.ailmentName.present
          ? data.ailmentName.value
          : this.ailmentName,
    );
  }
...
class UnitAttackPatternData extends DataClass
  ...
  UnitAttackPatternData copyWithCompanion(UnitAttackPatternCompanion data) {
    return UnitAttackPatternData(
      ...
      atkPattern1: data.atkPattern1.present
          ? data.atkPattern1.value
          : this.atkPattern1,
      atkPattern2: data.atkPattern2.present
          ? data.atkPattern2.value
          : this.atkPattern2,
      atkPattern3: data.atkPattern3.present
          ? data.atkPattern3.value
          : this.atkPattern3,
      atkPattern4: data.atkPattern4.present
          ? data.atkPattern4.value
          : this.atkPattern4,
      atkPattern5: data.atkPattern5.present
          ? data.atkPattern5.value
          : this.atkPattern5,
      atkPattern6: data.atkPattern6.present
          ? data.atkPattern6.value
          : this.atkPattern6,
      atkPattern7: data.atkPattern7.present
          ? data.atkPattern7.value
          : this.atkPattern7,
      atkPattern8: data.atkPattern8.present
          ? data.atkPattern8.value
          : this.atkPattern8,
      atkPattern9: data.atkPattern9.present
          ? data.atkPattern9.value
          : this.atkPattern9,
  ...
  SpSkillLabelDataData copyWithCompanion(SpSkillLabelDataCompanion data) {
    return SpSkillLabelDataData(
      ...
      normalLabelText: data.normalLabelText.present
          ...
          : this.normalLabelText,
      spLabelText: data.spLabelText.present
          ? data.spLabelText.value
          : this.spLabelText,
    );
  }
...
class $UnitSkillDataRFTable extends UnitSkillDataRF
  ...
  UnitSkillDataRFData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return UnitSkillDataRFData(
      ...
      rfSkillId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}rf_skill_id'],
      )!,
      minLv: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}min_lv'],
      )!,
      maxLv: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
...
class $UnitUniqueEquipTable extends UnitUniqueEquip
  ...
  UnitUniqueEquipData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return UnitUniqueEquipData(
      ...
      equipId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
...
class UniqueEquipmentDataData extends DataClass
  ...
  UniqueEquipmentDataData copyWith({
    ...
    equipmentName: equipmentName.present
        ...
        : this.equipmentName,
    description: description.present ? description.value : this.description,
    promotionLevel: promotionLevel.present
    ...
    physicalCritical: physicalCritical.present
        ...
        : this.physicalCritical,
    magicCritical: magicCritical.present
        ? magicCritical.value
        : this.magicCritical,
    waveHpRecovery: waveHpRecovery.present
        ? waveHpRecovery.value
        : this.waveHpRecovery,
    ...
    physicalPenetrate: physicalPenetrate.present
        ...
        : this.physicalPenetrate,
    magicPenetrate: magicPenetrate.present
        ? magicPenetrate.value
        : this.magicPenetrate,
    lifeSteal: lifeSteal.present ? lifeSteal.value : this.lifeSteal,
    hpRecoveryRate: hpRecoveryRate.present
    ...
    energyReduceRate: energyReduceRate.present
        ...
        : this.energyReduceRate,
    enableDonation: enableDonation.present
        ? enableDonation.value
        : this.enableDonation,
...
class $UnlockUnitConditionTable extends UnlockUnitCondition
  ...
  static const VerificationMeta _preUnitIdMeta = const VerificationMeta(
    'preUnitId',
  );
  @override
  ...
  static const VerificationMeta _conditionType_1Meta = const VerificationMeta(
    'conditionType_1',
  );
  @override
  ...
  late final GeneratedColumn<int> conditionTypeDetail_1 = GeneratedColumn<int>(
    'condition_type_detail_1',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: true,
  );
  static const VerificationMeta _conditionId_1Meta = const VerificationMeta(
    'conditionId_1',
  );
  @override
  ...
  static const VerificationMeta _count_1Meta = const VerificationMeta(
    'count_1',
  );
  @override
  ...
  static const VerificationMeta _conditionType_2Meta = const VerificationMeta(
    'conditionType_2',
  );
  @override
  ...
  late final GeneratedColumn<int> conditionTypeDetail_2 = GeneratedColumn<int>(
    'condition_type_detail_2',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: true,
  );
  static const VerificationMeta _conditionId_2Meta = const VerificationMeta(
    'conditionId_2',
  );
  @override
  ...
  static const VerificationMeta _count_2Meta = const VerificationMeta(
    'count_2',
  );
  @override
  ...
  static const VerificationMeta _conditionType_3Meta = const VerificationMeta(
    'conditionType_3',
  );
  @override
  ...
  late final GeneratedColumn<int> conditionTypeDetail_3 = GeneratedColumn<int>(
    'condition_type_detail_3',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: true,
  );
  static const VerificationMeta _conditionId_3Meta = const VerificationMeta(
    'conditionId_3',
  );
  @override
  ...
  static const VerificationMeta _count_3Meta = const VerificationMeta(
    'count_3',
  );
  @override
  ...
  static const VerificationMeta _conditionType_4Meta = const VerificationMeta(
    'conditionType_4',
  );
  @override
  ...
  late final GeneratedColumn<int> conditionTypeDetail_4 = GeneratedColumn<int>(
    'condition_type_detail_4',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: true,
  );
  static const VerificationMeta _conditionId_4Meta = const VerificationMeta(
    'conditionId_4',
  );
  @override
  ...
  static const VerificationMeta _count_4Meta = const VerificationMeta(
    'count_4',
  );
  @override
  ...
  static const VerificationMeta _conditionType_5Meta = const VerificationMeta(
    'conditionType_5',
  );
  @override
  ...
  late final GeneratedColumn<int> conditionTypeDetail_5 = GeneratedColumn<int>(
    'condition_type_detail_5',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: true,
  );
  static const VerificationMeta _conditionId_5Meta = const VerificationMeta(
    'conditionId_5',
  );
  @override
  ...
  static const VerificationMeta _count_5Meta = const VerificationMeta(
    'count_5',
  );
  @override
  ...
  static const VerificationMeta _releaseEffectTypeMeta = const VerificationMeta(
    'releaseEffectType',
  );
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('pre_unit_id')) {
      context.handle(
        _preUnitIdMeta,
        preUnitId.isAcceptableOrUnknown(data['pre_unit_id']!, _preUnitIdMeta),
      );
    } else if (isInserting) {
  ...
  UnlockUnitConditionData map(
    ...
    return UnlockUnitConditionData(
      ...
      preUnitId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}pre_unit_id'],
      )!,
      conditionType_1: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}condition_type_1'],
      )!,
      conditionTypeDetail_1: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}condition_type_detail_1'],
      )!,
      conditionId_1: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}condition_id_1'],
      )!,
      count_1: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}count_1'],
      )!,
      conditionType_2: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}condition_type_2'],
      )!,
      conditionTypeDetail_2: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}condition_type_detail_2'],
      )!,
      conditionId_2: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}condition_id_2'],
      )!,
      count_2: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}count_2'],
      )!,
      conditionType_3: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}condition_type_3'],
      )!,
      conditionTypeDetail_3: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}condition_type_detail_3'],
      )!,
      conditionId_3: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}condition_id_3'],
      )!,
      count_3: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}count_3'],
      )!,
      conditionType_4: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}condition_type_4'],
      )!,
      conditionTypeDetail_4: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}condition_type_detail_4'],
      )!,
      conditionId_4: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}condition_id_4'],
      )!,
      count_4: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}count_4'],
      )!,
      conditionType_5: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}condition_type_5'],
      )!,
      conditionTypeDetail_5: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}condition_type_detail_5'],
      )!,
      conditionId_5: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}condition_id_5'],
      )!,
      count_5: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}count_5'],
      )!,
      releaseEffectType: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}release_effect_type'],
      ),
    );
  }
...
class UnlockUnitConditionData extends DataClass
  ...
  factory UnlockUnitConditionData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return UnlockUnitConditionData(
      ...
      conditionTypeDetail_1: serializer.fromJson<int>(
        json['conditionTypeDetail_1'],
      ),
      ...
      conditionTypeDetail_2: serializer.fromJson<int>(
        json['conditionTypeDetail_2'],
      ),
      ...
      conditionTypeDetail_3: serializer.fromJson<int>(
        json['conditionTypeDetail_3'],
      ),
      ...
      conditionTypeDetail_4: serializer.fromJson<int>(
        json['conditionTypeDetail_4'],
      ),
      ...
      conditionTypeDetail_5: serializer.fromJson<int>(
        json['conditionTypeDetail_5'],
      ),
  ...
  UnlockUnitConditionData copyWith({
    ...
    conditionTypeDetail_1: conditionTypeDetail_1 ?? this.conditionTypeDetail_1,
    ...
    conditionTypeDetail_2: conditionTypeDetail_2 ?? this.conditionTypeDetail_2,
    ...
    conditionTypeDetail_3: conditionTypeDetail_3 ?? this.conditionTypeDetail_3,
    ...
    conditionTypeDetail_4: conditionTypeDetail_4 ?? this.conditionTypeDetail_4,
    ...
    conditionTypeDetail_5: conditionTypeDetail_5 ?? this.conditionTypeDetail_5,
...
class UnlockUnitConditionCompanion
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (conditionTypeDetail_1.present) {
      map['condition_type_detail_1'] = Variable<int>(
        conditionTypeDetail_1.value,
      );
    }
    ...
    if (conditionTypeDetail_2.present) {
      map['condition_type_detail_2'] = Variable<int>(
        conditionTypeDetail_2.value,
      );
    }
    ...
    if (conditionTypeDetail_3.present) {
      map['condition_type_detail_3'] = Variable<int>(
        conditionTypeDetail_3.value,
      );
    }
    ...
    if (conditionTypeDetail_4.present) {
      map['condition_type_detail_4'] = Variable<int>(
        conditionTypeDetail_4.value,
      );
    }
    ...
    if (conditionTypeDetail_5.present) {
      map['condition_type_detail_5'] = Variable<int>(
        conditionTypeDetail_5.value,
      );
    }
...
class $$UnlockUnitConditionTableTableManager
    extends
        RootTableManager<
          _$AppDb,
  ...
  $$UnlockUnitConditionTableTableManager(
    _$AppDb db,
    $UnlockUnitConditionTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$UnlockUnitConditionTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDb,
      $UnlockUnitConditionTable,
      UnlockUnitConditionData,
